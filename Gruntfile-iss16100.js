  ...
  grunt.initConfig({
        ...
        files: [
          {
            ...
            cwd: './<%= source%>',
            src: [
              'blocks/catalog-recommend/*.jade',
              'components/catalog.recommend/template.jade'
            ],
            dest: '<%= dest%>',
            ext: '.html',
            extDot: 'first'
    ...
    stylus: {
      ...
      issue: {
        files: [
          {
            '<%= dest%>components/catalog.recommend/style.css': '<%= source%>components/catalog.recommend/style.styl'
          }
        ]
      },
    ...
    uglify: {
      ...
      issue: {
        ...
        files: [
          {
            '<%= dest %>components/catalog.recommend/script.js': '<%= source %>components/catalog.recommend/script.js'
          }
        ]
      },
    ...
    watch: {
      ...
      htmlGeneral: {
        files: [
          ...
          '!<%= source %>components/catalog.recommend/**/*.jade',
          '!<%= source %>blocks/catalog-recommend/**/*.jade'
        ],
        tasks: 'jade:dev'
      },
      ...
      cssGeneral: {
        files: [
          '<%= source %>**/*.styl',
          //change component name
          '!<%= source %>components/catalog.recommend/**/*.styl',
          '!<%= source %>blocks/catalog-recommend/**/*.styl'
        ],
        tasks: 'css'
      },
      ...
      jsGeneral: {
        files: [
          ...
          //change component name
          '!<%= source %>components/catalog.recommend/**/*.js'
        ],
        tasks: [ 'js' ]
      },
